...
import { getFilePathsMatchingPattern } from "./utils.js";
...
function getSelfVersion(length = 7) {
  ...
  const filepaths = [
    ...
    ...getFilePathsMatchingPattern(path.join(root, "lib", "**", "*.js")),
    // And every every other file too
    ...getFilePathsMatchingPattern(path.join(root, "editor", "**", "*.js")),
    ...getFilePathsMatchingPattern(path.join(root, "editor", "**", "*.css")),
    ...getFilePathsMatchingPattern(path.join(root, "editor", "**", "*.html")),
  ];
...
export function buildPages() {
  ...
  return new Promise((resolve, reject) => {
    const metaJSONArray = getFilePathsMatchingPattern(config.metaGlob);
